...
# Generate Plot #4
# Set a 2x2 array for holding multiple plots
par(mfrow=c(2,2), mar=c(4,4,2,1), oma=c(0,0,2,0));
# Plot position 1,1
plot(household_power$Time, household_power$Global_active_power, type="o", ylab="Global Active Power (kilowatts)", xlab="", pch=".");
# Plot position 1,2
plot(household_power$Time, household_power$Voltage, type="o", ylab="Voltage", xlab="datetime", pch=".");
# Plot position 2,1
plot(household_power$Time, household_power$Sub_metering_1, type="o", ylab="Energy sub metering", xlab="", pch=".");
lines(household_power$Time, household_power$Sub_metering_2, type="o", pch=".", col="Red");
